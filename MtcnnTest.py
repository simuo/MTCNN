...
class mtcnnTest():
    ...
    def __pnet_detect(self, image):
        ...
        while min_side_len > 12:
            ...
            _cls, _offset, _iou = self.pnet(img_data)
    ...
    def __rnet_detect(self, image, pnet_boxes):
        ...
        _cls, _offset, _iou = self.rnet(img_dataset)
